...
const Doctors = () => {
  ...
  //useEffect for doctor's info callback
  useEffect(() => {
  ...
  //useEffect for handling search algorithm
  useEffect(() => {
    handleSearch();
  }, [searchText]);
      ...
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.title}>
            Doctor <Text style={{ color: "#075eec" }}>Details</Text>
          </Text>
              ...
              {filteredDoctors.length === 0 ? (
                error ? (
                  <Text style={{color: "red",textAlign: "center"}}>
                    No doctor found with the entered username
                  </Text>
                ) : (
                  doctors.map((user) => (
